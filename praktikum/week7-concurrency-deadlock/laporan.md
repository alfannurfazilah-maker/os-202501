...
## Pendahuluan
- **Latar Belakang**
> *Concurrency generally means ‘multiple things going on at the same time* atau konkruensi secara umum didefiniskan sebagai 'hal-hal yang dikerjakan dalam waktu bersamaan', (OSTEP, 2018). Konkruensi terjadi di dalam sistem operasi karena banyaknya tugas-tugas dilakukan secara bersamaan di dalam program. Deadlock memiliki pengertian, *a set of blocked processes each holding a resource and waiting to acquire a resource held by another process in the set* atau seperangkat proses yang diblokir, masing-masing memegang sebuah sumber daya dan menunggu untuk memperoleh sumber daya yang dimiliki oleh proses lain dalam himpunan tersebut, (Silberschatz, Galvin & Gagne, Operating System Concepts, 10th Edition, Wiley, 2018). Buku itu juga menjelaskan bahwa terdapat empat kondisi yang memenuhi syarat terjadinya deadlock, yaitu, 1.) *Mutual exclusion*, setidaknya satu sumber daya tidak bisa dibagi atau hanya satu proses pada satu waktu. 2.) *Hold and wait*, sebuah proses memegang satu atau lebih sumber daya, sambil menunggu sumber daya lain yang dipegang oleh proses lain. 3.) *No preemption*, sumber daya yang sudah dipegang proses tidak bisa direbut paksa; hanya dilepas secara sukarela oleh proses yang memegangnya. 4.) *Circular wait*, terdapat rangkaian proses {P0, P1, …, Pn} dimana P0 menunggu sumber daya yang dipegang P1, P1 menunggu dari P2, …, Pn menunggu dari P0. Jadi, konkruensi deadlock adalah sekumpulan tugas yang dilakukan dalam satu waktu dengan terpenuhinya keempat syarat, yaitu *mutual exclusion*; *hold and wait*; *no preemption*; dan *circular wait*, sehingga program tidak berjalan atau terjadi deadlock. Tugas kelompok ini diberikan dengan tujuan utama untuk mengetahui dan memahami konkruesi deadlock secara berkelompok. Pemberian tugas secara berkelompok juga memudahkan mahasiswa-mahasiswa yang terkait dan melatih kerja sama tim dalam menyelesaikan masalah-masalah IT.
- **Dasar Teori**
...
> Bekerja dalam bagian analisis bagian yang paling menantang minggu ini adalah memahami perbedaan kondisi sistem sebelum dan sesudah deadlock terjadi.
- Bagaimana cara Anda mengatasinya?  
> Mendiskusikannya dengan teman dan juga bertanya tanya ke AI
---
